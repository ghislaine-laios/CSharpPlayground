...
namespace DemoSite.Models
{
    ...
    public class FullUserPayload : BaseUserPayload
    {
        ...
        {
            return new FullUserPayload { Password = "", Username = user.Username, UserData = UserDataPayload.From(user.UserData) };
        }
    }
    ...
    public class User
    {
        ...
        public void SetPassword(string rawPassword)
        {
            ...
            this.HashedPassword = multiHash.ToString(MultibaseEncoding.Base64);
        }
